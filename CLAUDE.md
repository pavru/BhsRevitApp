...
>
> **Revit 2027 — тоже всё зелёное.** На **Revit 2024 не работает** — конфликт `System.Memory`,
> разобран выше. Под чужой учётной записью по-прежнему не проверено.
>
> Закрытие изнутри стоит по-разному и заметно: **9 с** на 2025, **31 с** на 2026, **70 с** на 2027.
> Бюджет прогона считать по худшему, а не по среднему.
>
