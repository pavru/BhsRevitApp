...
- **Стек** — .NET + C#. UI: WPF как базовая линия. WinUI 3 — кандидат, решение принимается по результатам
  исследования; ограничение см. ниже.
...
> Пока 2024 в поддержке, WinUI 3 применим только в Win-side процессах.
